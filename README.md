...
Per-module write-ups: [`docs/01-module-1-foundation.md`](docs/01-module-1-foundation.md), [`docs/02-module-2-auth-core-schema.md`](docs/02-module-2-auth-core-schema.md), [`docs/03-module-3-projects-dashboard.md`](docs/03-module-3-projects-dashboard.md).
