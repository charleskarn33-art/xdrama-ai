    ...
    <main className="flex flex-1 flex-col items-center justify-center gap-10 px-6 py-24">
      ...
      <Card className="w-full max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Modules 1–16 are live — from the repo scaffold and auth/org
            ...
            builder and cross-tenant Admin Dashboard, all built on the shared
            AI Model Manager, Router, and Workflow Engine. See the per-module
            docs for details.
          </CardDescription>
        </CardHeader>
        <CardContent>
